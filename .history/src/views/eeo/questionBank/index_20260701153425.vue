    ...
    <el-dialog v-model="subjectDialogOpen" title="添加学段学科" width="520px" class="eeo-dialog">
      ...
      <div class="chip-row">
        <template v-for="stage in stageOptions" :key="stage">
          ...
          <el-popover v-else-if="!stages.includes(stage)" trigger="hover" placement="bottom-end" width="84" popper-class="stage-popover">
            <template #reference>
...
:global(.stage-popover .stage-menu-item) { height: 44px; display: flex; align-items: center; gap: 10px; padding: 0 18px; color: #30363d; cursor: pointer; font-size: 15px; }
:global(.stage-popover .stage-menu-item + .stage-menu-item) { border-top: 1px solid #f0f0f0; }
